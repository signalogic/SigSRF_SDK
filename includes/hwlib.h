/*
 ...
 Revision History
  ...
  Modified Jan 2020 JHB, add DS_DATAFILE_USE_SEMAPHORE flag for DSSaveDataFile() and DSLoadDataFile() APIs, which indicates that filelib semaphore should be in effect. Intended for multi-thread applications; an alternative method is to call DSCreateFilelibThread() (in filelib.h) for each thread after creation, which is intended for very high capacity, high performance apps
...
#define DS_DATAFILE_USE_SEMAPHORE       0x1000000L
