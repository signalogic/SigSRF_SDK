...
* the dashed line indicates high-level pktlib APIs such as DSPushPackets() and DSPullPackets() available to user applications. For example pktlib API usage see the [mediaMin Minimum API Interface](https://github.com/signalogic/SigSRF_SDK/blob/master/mediaTest_readme.md#content-user-minimumapiinterface) and look for PushPackets() and PullPackets() in [mediaMin.cpp source code](https://github.com/signalogic/SigSRF_SDK/blob/master/apps/mediaMin/mediaMin.cpp)

* for data flow diagrams, see [telecom and analytics mode data flow diagrams](https://github.com/signalogic/SigSRF_SDK#content-user-telecommodedataflowdiagram) on the main SigSRF SDK page
