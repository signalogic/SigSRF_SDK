...
At the end of stream, mediaMin will display channel, session, jitter buffer, and other stats, along with event log warning and error message summaries (if any):
