...
> 0x8000000 (ENABLE_JITTER_BUFFER_OUTPUT_PCAPS) - enable xxx_jbN.pcap files generated by mediaMin if they should be needed for media quality analysis or other packet inspection. Otherwise the default is disabled to avoid unnecessary file space usage<br/>
