...
Complete info is in the <a href="https://github.com/signalogic/SigSRF_SDK/blob/master/Signalogic_software_errata_updates_2-3Q22.pdf"> errata and update PDF doc</a> (note - if Github page shows "unable to render rich display" click on "Download" :-)
