...
> **ENABLE_SSRC_SESSION_MATCHING** (0x2000) - enable SSRC session matching. Allows sessions with different IP addrs/ports to be joined with a previous session if their SSRCs match. This flag should only be applied when DYNAMIC_SESSIONS is enabled<br/>
