...
Below are some items to keep in mind when measuring audio quality of individual streams and also stream group output. The subject is complex and extensive, partly subjective as well as quantifiable, so these are key points, not an in-depth discussion.
