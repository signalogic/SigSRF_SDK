...
The above command can be run with wideband audio pcaps included in the SDK; look under the mediaTest/pcaps subfolder for pcaps that include "EVS" and/or "AMRWB" in the filename. For basic single stream testing, the asr_test2, asr_test3, and asr_test4 pcaps are also included in the SDK. The "asr_testN" pcaps were generated by mediaTest from wav files see [Converting Wav to Pcaps](#user-content-convertingwav2pcaps) using the EVS codec.
...
3. Capacity with ASR enabled is substantially reduced.  For more information on capacity / real-time performance, see <a href="https://github.com/signalogic/SigSRF_SDK#user-content-asrnotes">ASR Notes></a>
