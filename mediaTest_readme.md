...
2) pktlib packet/media thread processing ([packet_flow_media_proc.c](https://github.com/signalogic/SigSRF_SDK/blob/master/apps/mediaTest/packet_flow_media_proc.c)), which is used indirectly by the mediaMin reference application, via pktlib
