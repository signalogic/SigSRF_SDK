...
* The combination of colors is similar to "inferno" or "magma" colormaps in Matlab and R, which are known as perceptually uniform colormaps, for which researches have found that the human brain perceives data steps as equal steps in the color space
