...
/* DS_LOG_LEVEL_SUBSITUTE_WEC flag substitutes one character in words warning, error, or critical in event log text, notes:  JHB Jan2021
...
#define DS_LOG_LEVEL_SUBSITUTE_WEC        0x40000
