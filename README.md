...
SigSRF software is designed to be run on private, public, or hybrid cloud servers.  Demos available on this page are intended to run on any Linux server in any form-factor, including x86, ARM, and PowerPC.
