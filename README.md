...
#### $\textcolor{red}{\textsf{Note: if the above wildcard commands fail (which can happen from time-to-time due to Github server maintenance), then use the following file-specific commands:}}$
