...
<i><b>Important Note 2:</b> the install script .sh file has Windows CR/LF line endings. The wget command above converts these to Linux line endings. If you download the script manually you will need to convert line endings, for example: echo "$(tr -d '\r' < autoInstall_SigSRF_SDK_2022v7.sh)" > autoInstall_SigSRF_SDK_2022v7.sh.</i>
