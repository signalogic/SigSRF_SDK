...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[mediaTest Linux codec command line examples](https://www.github.com/signalogic/SigSRF_SDK/blob/master/mediaTest_readme.md#user-content-mediaTest_codecs)<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[mediaTest Linux AMR and AMR-WB examples](https://www.github.com/signalogic/SigSRF_SDK/blob/master/mediaTest_readme.md##user-content-mediaTest_amr)<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[mediaTest Linux EVS examples](https://www.github.com/signalogic/SigSRF_SDK/blob/master/mediaTest_readme.md#user-content-mediaTest_evs)<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[mediaTest Linux MELPe examples](https://www.github.com/signalogic/SigSRF_SDK/blob/master/mediaTest_readme.md#user-content-mediaTest_melpe)<br/>
...
![SigSRF software telecom mode data flow diagram](https://raw.githubusercontent.com/signalogic/SigSRF_SDK/master/images/Streaming_packet_and_media_processing_data_flow_telecom_mode_RevA9b.png "SigSRF telecom mode data flow diagram")
...
![SigSRF software analytics mode data flow diagram](https://raw.githubusercontent.com/signalogic/SigSRF_SDK/master/images/Streaming_packet_and_media_processing_data_flow_analytics_mode_RevA9b.png "SigSRF analytics mode data flow diagram")
...
![server capacity equations](https://raw.githubusercontent.com/signalogic/SigSRF_SDK/master/images/server_capacity_math_equations.png "server capacity math equations")
...
![SigSRF software and streaming I/O architecture diagram](https://raw.githubusercontent.com/signalogic/SigSRF_SDK/master/images/SigSRF_Software_Architecture_and_Packet_IO_RevA2.png "SigSRF software and streaming I/O architecture diagram")
...
<img src="https://raw.githubusercontent.com/signalogic/SigSRF_SDK/master/images/ubuntu_base_container_docker_hub_profile.png" width=50% alt="Ubuntu base container Docker hub profile info" title="Ubuntu base container Docker hub profile info"></br>
...
<img src="https://raw.githubusercontent.com/signalogic/SigSRF_SDK/master/images/centos_base_container_docker_hub_profile.png" width=50% alt="CentOS base container Docker hub profile info" title="CentOS base container Docker hub profile info"></br>
...
```
wget https://raw.githubusercontent.com/signalogic/SigSRF_SDK/master/rar_packages/Signalogic_sw_host_SigSRF_SDK_Ubuntu12.04-22.04_23Jun25.rar --content-disposition -O Signalogic_sw_host_SigSRF_SDK_Ubuntu12.04-22.04_23Jun25.rar
```
CentOS .rar
```
wget https://raw.githubusercontent.com/signalogic/SigSRF_SDK/master/rar_packages/Signalogic_sw_host_SigSRF_SDK_CentOS6-8_23Jun25.rar --content-disposition -O Signalogic_sw_host_SigSRF_SDK_CentOS6-8_23Jun25.rar
```
...
mediaMin is a production reference application, using a minimum set of APIs (create/delete session, push/pull packets), it can handle a wide range of RTP audio and video packet inputs. mediaTest is focused on test and measurement functionality and accepts USB and wav file audio input. Some things you can do with mediaMin and mediaTest command lines:
  ...
  * test codecs and compare output vs. 3GPP or ITU reference files <sup>1</sup>. The [codecs documentation](https://github.com/signalogic/SigSRF_SDK/blob/master/codecs_readme.md) page includes API interface and definitions
...
[mediaTest and mediaMin reference applications and source code](https://github.com/signalogic/SigSRF_SDK/blob/master/mediaTest_readme.md), including:

  * numerous command line examples included in the Rar packages and Docker containers
  * use case examples (pcap players, OpenLI, ASR, conversation stream merging, dynamic session creation, etc)
  * command line options quick reference

[codecs documentation](https://github.com/signalogic/SigSRF_SDK/blob/master/codecs_readme.md), including:

  * API interface and definitions for voplib (voice/video over packet library)

[pktlib documentation](https://github.com/signalogic/SigSRF_SDK/blob/master/pktlib_readme.md), including:

  * API interface and definitions for pktlib (packet library) packet information extract, jitter buffer, statistics, and more
  * Pcap, pcapng, and rtp/rtpdump file management, editing, search, and filtering

Legacy SigSRF documentation, including Quick Start command line examples, High Capacity Operation, API Usage, and other sections is located at:
