...
Filter specs that produced the coefficients:
  ...
  Narrowband to Mediumband, Super Wideband to Fullband (e.g. 8 -> 12, 24 -> 32, 32 -> 48)
   ...
   44.1 kHz to wideband
    -134 tap, 22.05 kHz Fc, 16 kHz Fs, 550 Hz transition band
    -stopband attenuation 30 dB
    -passband ripple 1 dB

   wideband to 44.1 kHz
    -88 tap, 22.05 kHz Fc, 48 kHz Fs, 850 Hz transition band
    -stopband attenuation 30 dB
    -passband ripple 1 dB
*/
...
#ifdef _C66XX_
#pragma DATA_ALIGN(fir_filt_up160_down441, 8)
#endif
const short int fir_filt_up160_down441[134] = {  /* convert audio 44.1 kHz to telecom 16 kHz */
14,
62,
46,
-23,
...
const float fir_filt_up160_down441_float[134] = { 0 };

const UInt16 FIR_FILT_UP160_DOWN441_SIZE = sizeof(fir_filt_up160_down441)/sizeof(Int16);

#ifdef _C66XX_
#pragma DATA_ALIGN(fir_filt_up441_down160, 8)
#endif
const short int fir_filt_up441_down160[88] = {  /* convert telecom 16 kHz to audio 44.1 kHz */
-69,
25,
104,
72,
...
const float fir_filt_up441_down160_float[88] = { 0 };

const UInt16 FIR_FILT_UP441_DOWN160_SIZE = sizeof(fir_filt_up441_down160)/sizeof(Int16);
