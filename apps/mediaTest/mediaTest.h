...
extern volatile unsigned int uLineCursorPos;  /* may be referenced by apps if they want to know / set the current screen line cursor position. These 4 vars are declared in diaglib.so */
